...
class DraftSetupPickCommands(commands.Cog):
    ...
    async def cancel_draft(self, ctx):
        ...
        if not isinstance(ctx.channel, discord.channel.DMChannel):
            embed = discord.Embed(description = self.setup_logic.cancel_draft(), colour = discord.Color.blue())
    ...
    async def draft_setup(self, ctx, players : str, picks : str):
        ...
        if not isinstance(ctx.channel, discord.channel.DMChannel):
            embed = discord.Embed(description = self.setup_logic.setup_draft(players, picks), colour = discord.Color.blue())
            await ctx.send(embed = embed)  
    ...
    async def edit_player(self, ctx, player_count : str):
        ...
        if not isinstance(ctx.channel, discord.channel.DMChannel):
            embed = discord.Embed(description = self.setup_logic.edit_player(player_count), colour = discord.Color.blue())
            await ctx.send(embed = embed)
    ...
    async def edit_pick(self, ctx, pick_count : str):
        ...
        if not isinstance(ctx.channel, discord.channel.DMChannel):
            embed = discord.Embed(description = self.setup_logic.edit_pick(pick_count), colour = discord.Color.blue())
            await ctx.send(embed = embed)
    ...
    async def info(self, ctx):
        ...
        if not isinstance(ctx.channel, discord.channel.DMChannel):
            embed = discord.Embed(description = self.setup_logic.info_draft(), colour = discord.Color.blue())
            await ctx.send(embed = embed)
    ...
    async def join(self, ctx):
        ...
        if not isinstance(ctx.channel, discord.channel.DMChannel):
            embed = discord.Embed(description = self.setup_logic.join_draft(ctx.message.author.name, ctx.author.mention), colour = discord.Color.blue())
            await ctx.send(embed = embed)
    ...
    async def leave(self, ctx):
        ...
        if not isinstance(ctx.channel, discord.channel.DMChannel):
            embed = discord.Embed(description = self.setup_logic.leave_draft(ctx.message.author.name, ctx.author.mention), colour = discord.Color.blue())
            await ctx.send(embed = embed)
    ...
    async def fire_draft(self, ctx):
        ...
        if not isinstance(ctx.channel, discord.channel.DMChannel):
            ...
            if self.setup_logic.draft_fired:
                embed = discord.Embed(description = self.setup_logic.fire_draft(), colour = discord.Color.blue())
                await ctx.send(embed = embed)   
            ...
            # otherwise attempt to fire
                ...
                if self.setup_logic.draft_fired:
                    ...
                    names_mentions = list(zip(list(self.setup_logic.players.values()), list(self.setup_logic.players.keys()))) 
    ...
    async def pick(self, ctx, *card : str):
        ...
        """This allows a user to pick a card from the draft. the draft
        needs to have fired for this to work."""
